...
#define STRING_CONFIG_H_AUTHOR "liujiahan@gmail.com" // Who made the changes.
...
#define MACHINE_UUID "27765839-bf1b-4e96-aecb-baf070c8fdf8"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 300.00 // get this value from auto calibrat
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_X -53
  #define ABL_PROBE_PT_1_Y -28
  #define ABL_PROBE_PT_2_X 53
  #define ABL_PROBE_PT_2_Y -28
  #define ABL_PROBE_PT_3_X 0
  #define ABL_PROBE_PT_3_Y 53
  ...
  #define UBL_PROBE_PT_1_Y -28
  #define UBL_PROBE_PT_2_X 53
  #define UBL_PROBE_PT_2_Y -28
...
#define MANUAL_Z_HOME_POS 330 // Distance between the nozzle to printbed after homing
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT {-90, 0, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   {90, 0, (Z_MIN_POS + 1)}

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 90
  // Circular pattern circle fragments number
  #define NOZZLE_CLEAN_CIRCLE_FN 60
  // Middle point of circle
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE {0, 0, (Z_MIN_POS + 1)}
